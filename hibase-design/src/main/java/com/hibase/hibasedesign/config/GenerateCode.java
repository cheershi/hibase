package com.hibase.hibasedesign.config;
...
public class GenerateCode {
    ...
    public static String MYBATIS_BASEDO = "com.hibase.common.web.entity.po.BasePo";

    public static String BASEPAGE_BASEDO = "com.hibase.common.web.entity.vo.PageBase";

    public static String IMPORT_BASEDO = "com.alibaba.excel.metadata.BaseRowModel";

    public static String MYBATIS_WEBDO = "com.hibase.hibaseweb.web.BaseController";

    public static String MYBATIS_SERVICEIMPL = "com.hibase.hibaseweb.service.impl.BaseServiceImpl";

    public static String MYBATIS_SERVICE = "com.hibase.hibaseweb.service.BaseService";
    ...
    public static String SUPER_ENTITY_COLUMNS = "id,created_by,created_time,update_by,update_time,be_deleted";
