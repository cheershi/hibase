...
public class ConfigBuilder {
    ...
    @Getter
    private String superEntityInsertVOClass;
    @Getter
    private String superEntityUpdateVOClass;
    @Getter
    private String superEntityVOClass;
    @Getter
    private String superEntitySearchVOClass;
    @Getter
    private String superEntityDetailVOClass;
    @Getter
    private String superEntityImportVOClass;
    @Getter
    private String superEntityExportVOClass;
    ...
    private void handlerPackage(TemplateConfig template, String outputDir, PackageConfig config) {
        ...
        packageInfo.put(ConstVal.ENTITYVO, joinPackage(config.getParent(), config.getEntityVo()));
        ...
        if (null != configPathInfo) {
            ...
            // 生成路径信息
            pathInfo = new HashMap<>(13);
            setPathInfo(pathInfo, template.getEntity(getGlobalConfig().isKotlin()), outputDir, ConstVal.ENTITY_PATH, ConstVal.ENTITY);
            setPathInfo(pathInfo, template.getEntity(getGlobalConfig().isKotlin()), outputDir, ConstVal.ENTITY_VO_PATH, ConstVal.ENTITYVO);
            setPathInfo(pathInfo, template.getEntity(getGlobalConfig().isKotlin()), outputDir, ConstVal.ENTITY_VO_PATH, ConstVal.ENTITYVO);
            setPathInfo(pathInfo, template.getEntity(getGlobalConfig().isKotlin()), outputDir, ConstVal.ENTITY_VO_PATH, ConstVal.ENTITYVO);
            setPathInfo(pathInfo, template.getEntity(getGlobalConfig().isKotlin()), outputDir, ConstVal.ENTITY_VO_PATH, ConstVal.ENTITYVO);
            setPathInfo(pathInfo, template.getEntity(getGlobalConfig().isKotlin()), outputDir, ConstVal.ENTITY_VO_PATH, ConstVal.ENTITYVO);
    ...
    private void processTypes(StrategyConfig config) {
        ...
        superEntityInsertVOClass = config.getSuperInsertVOClass();
        superEntityUpdateVOClass = config.getSuperUpdateVOClass();
        superEntityVOClass = config.getSuperEntityVOClass();
        superEntitySearchVOClass = config.getSuperSearchVOClass();
        superEntityDetailVOClass = config.getSuperViewVOClass();
        superEntityImportVOClass = config.getSuperImportVOClass();
        superEntityExportVOClass = config.getSuperExportVOClass();
    ...
    private List<TableInfo> processTable(List<TableInfo> tableList, NamingStrategy strategy, StrategyConfig config) {
        ...
        for (TableInfo tableInfo : tableList) {
            ...
            tableInfo.setEntityInsertName(tableInfo.getEntityName() + EntityEnum.INSERTVO.getName());
            tableInfo.setEntityUpdateName(tableInfo.getEntityName() + EntityEnum.UPDATEVO.getName());
            tableInfo.setEntitySearchName(tableInfo.getEntityName() + EntityEnum.SEARCHVO.getName());
            tableInfo.setEntityViewName(tableInfo.getEntityName() + EntityEnum.VIEWVO.getName());
            tableInfo.setEntityVoName(tableInfo.getEntityName() + EntityEnum.LISTVO.getName());
            tableInfo.setEntityImportName(tableInfo.getEntityName() + EntityEnum.IMPORTVO.getName());
            tableInfo.setEntityExportName(tableInfo.getEntityName() + EntityEnum.EXPORTVO.getName());
            ...
            tableInfo.setServiceAliasName(fristToLowerCase(tableInfo.getServiceName()));
     ...
     * @return
     */
    private static String fristToLowerCase(String name) {
        ...
        if (StringUtils.isNotEmpty(name)) {
            ...
            result.append(frist.toLowerCase());
    ...
    private void checkImportPackages(TableInfo tableInfo) {
        ...
        if (StringUtils.isNotEmpty(strategyConfig.getSuperInsertVOClass())) {
            // 自定义父类
            tableInfo.getImportInsertVOPackages().add(strategyConfig.getSuperInsertVOClass());
        }
        if (StringUtils.isNotEmpty(strategyConfig.getSuperUpdateVOClass())) {
            // 自定义父类
            tableInfo.getImportUpdateVOPackages().add(strategyConfig.getSuperUpdateVOClass());
        }
        if (StringUtils.isNotEmpty(strategyConfig.getSuperVOClass())) {
            // 自定义父类
            tableInfo.getImportVOPackages().add(strategyConfig.getSuperVOClass());
        }
        if (StringUtils.isNotEmpty(strategyConfig.getSuperSearchVOClass())) {
            // 自定义父类
            tableInfo.getImportSearchVOPackages().add(strategyConfig.getSuperSearchVOClass());
        }
        if (StringUtils.isNotEmpty(strategyConfig.getSuperViewVOClass())) {
            // 自定义父类
            tableInfo.getImportDetailVOPackages().add(strategyConfig.getSuperViewVOClass());
        }
        if (StringUtils.isNotEmpty(strategyConfig.getSuperImportVOClass())) {
            // 自定义父类
            tableInfo.getImportImportVOPackages().add(strategyConfig.getSuperImportVOClass());
        }
        if (StringUtils.isNotEmpty(strategyConfig.getSuperExportVOClass())) {
            // 自定义父类
            tableInfo.getImportExportVOPackages().add(strategyConfig.getSuperExportVOClass());
            ...
            tableInfo.getImportInsertVOPackages().add(com.baomidou.mybatisplus.extension.activerecord.Model.class.getCanonicalName());
            tableInfo.getImportUpdateVOPackages().add(com.baomidou.mybatisplus.extension.activerecord.Model.class.getCanonicalName());
            tableInfo.getImportVOPackages().add(com.baomidou.mybatisplus.extension.activerecord.Model.class.getCanonicalName());
            tableInfo.getImportSearchVOPackages().add(com.baomidou.mybatisplus.extension.activerecord.Model.class.getCanonicalName());
            tableInfo.getImportDetailVOPackages().add(com.baomidou.mybatisplus.extension.activerecord.Model.class.getCanonicalName());
            tableInfo.getImportImportVOPackages().add(com.baomidou.mybatisplus.extension.activerecord.Model.class.getCanonicalName());
            tableInfo.getImportExportVOPackages().add(com.baomidou.mybatisplus.extension.activerecord.Model.class.getCanonicalName());
        }
        if (null != globalConfig.getIdType()) {
            ...
            tableInfo.getImportInsertVOPackages().add(com.baomidou.mybatisplus.annotation.IdType.class.getCanonicalName());
            tableInfo.getImportInsertVOPackages().add(com.baomidou.mybatisplus.annotation.TableId.class.getCanonicalName());

            tableInfo.getImportUpdateVOPackages().add(com.baomidou.mybatisplus.annotation.IdType.class.getCanonicalName());
            tableInfo.getImportUpdateVOPackages().add(com.baomidou.mybatisplus.annotation.TableId.class.getCanonicalName());

            tableInfo.getImportVOPackages().add(com.baomidou.mybatisplus.annotation.IdType.class.getCanonicalName());
            tableInfo.getImportVOPackages().add(com.baomidou.mybatisplus.annotation.TableId.class.getCanonicalName());

            tableInfo.getImportSearchVOPackages().add(com.baomidou.mybatisplus.annotation.IdType.class.getCanonicalName());
            tableInfo.getImportSearchVOPackages().add(com.baomidou.mybatisplus.annotation.TableId.class.getCanonicalName());

            tableInfo.getImportDetailVOPackages().add(com.baomidou.mybatisplus.annotation.IdType.class.getCanonicalName());
            tableInfo.getImportDetailVOPackages().add(com.baomidou.mybatisplus.annotation.TableId.class.getCanonicalName());

            tableInfo.getImportImportVOPackages().add(com.baomidou.mybatisplus.annotation.IdType.class.getCanonicalName());
            tableInfo.getImportImportVOPackages().add(com.baomidou.mybatisplus.annotation.TableId.class.getCanonicalName());

            tableInfo.getImportExportVOPackages().add(com.baomidou.mybatisplus.annotation.IdType.class.getCanonicalName());
            tableInfo.getImportExportVOPackages().add(com.baomidou.mybatisplus.annotation.TableId.class.getCanonicalName());
        }
        if (StringUtils.isNotEmpty(strategyConfig.getVersionFieldName())) {
            tableInfo.getFields().forEach(f -> {
                if (strategyConfig.getVersionFieldName().equals(f.getName())) {
                    ...
                    tableInfo.getImportInsertVOPackages().add(com.baomidou.mybatisplus.annotation.Version.class.getCanonicalName());
                    tableInfo.getImportUpdateVOPackages().add(com.baomidou.mybatisplus.annotation.Version.class.getCanonicalName());
                    tableInfo.getImportVOPackages().add(com.baomidou.mybatisplus.annotation.Version.class.getCanonicalName());
                    tableInfo.getImportSearchVOPackages().add(com.baomidou.mybatisplus.annotation.Version.class.getCanonicalName());
                    tableInfo.getImportDetailVOPackages().add(com.baomidou.mybatisplus.annotation.Version.class.getCanonicalName());
                    tableInfo.getImportImportVOPackages().add(com.baomidou.mybatisplus.annotation.Version.class.getCanonicalName());
                    tableInfo.getImportExportVOPackages().add(com.baomidou.mybatisplus.annotation.Version.class.getCanonicalName());
                }
            });
        }
    }
