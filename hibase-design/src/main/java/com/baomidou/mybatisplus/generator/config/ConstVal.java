...
public interface ConstVal {
    ...
    String ENTITY_VO_PATH = "entity_vo_path";
    ...
    String TEMPLATE_SEARCH_VO_JAVA = "/templates/entitySearchVO.java";
    String TEMPLATE_DETAIL_VO_JAVA = "/templates/entityDetailVO.java";
    String TEMPLATE_IMPORT_VO_JAVA = "/templates/entityImportVO.java";
    String TEMPLATE_VO_JAVA = "/templates/entityVO.java";
